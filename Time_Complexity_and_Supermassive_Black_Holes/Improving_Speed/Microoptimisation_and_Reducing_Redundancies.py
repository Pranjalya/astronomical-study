...
# So, for example, say we have a first catalogue object (the target) with a declination of δ and we’ve set our maximum match radius to r.
# The new algorithm will only loop over second catalogue objects with declinations between -90 (the start) and δ + r degrees before it breaks out of the loop.
